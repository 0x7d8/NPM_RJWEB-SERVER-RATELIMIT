  ...
  return {
    ...
    code: (ctr) => {
      ...
      for (let index = 0; index < rules.length; index++) {
        ...
        else if (rule.clients[ctr.client.ip].end.getTime() <= (/* @__PURE__ */ new Date()).getTime())
          rule.clients[ctr.client.ip] = { hits: 1, start: /* @__PURE__ */ new Date(), end: /* @__PURE__ */ new Date() };
        else
